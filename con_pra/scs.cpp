...
{
	int n;
  cout << "Enter how many number of pairs you have " << endl;
  cin >> n;
  Point a[n];
  for (int i = 0; i < n; i++)
  {
    cout << "Enter a x coordinate for pair " << i + 1 << endl;
    cin >> a[i].x;
    cout << "Enter a y coordinate for pair " << i + 1 << endl;
    cin >> a[i].y;
  }
	cout << "The smallest distance is " << closest(a, n);
	return 0;
}
